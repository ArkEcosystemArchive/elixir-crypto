defmodule ArkEcosystem.Crypto.Enums.Fees do
  def transfer do
    Application.get_env(:ark_crypto, :transactions)[:transfer_fee] || 10_000_000
  end

  def second_signature_registration do
    Application.get_env(:ark_crypto, :transactions)[:second_signature_fee] || 500_000_000
  end

  def delegate_registration do
    Application.get_env(:ark_crypto, :transactions)[:delegate_fee] || 2_500_000_000
  end

  def vote do
    Application.get_env(:ark_crypto, :transactions)[:vote_fee] || 100_000_000
  end

  def multi_signature_registration do
    Application.get_env(:ark_crypto, :transactions)[:multisignature_base_fee] || 500_000_000
  end
